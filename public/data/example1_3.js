...
R1.push={name:"sp", value:750, formula: "", measureUnit: "кг/м3", komment: "плотность пустотелого кирпич"};
R1.push={name:"v", value:3, formula: "", measureUnit: "м3", komment: "объем кирпича"};
R1.push={name:"m", value:"", formula: "sp+sp*v-p/p+v", measureUnit: "кг", komment: "вес кирпича"};
